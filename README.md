...
4. Download the patched FabGL library's source code from this branch. Download the source code as a .zip file, it will probably be named FabGL-FabGL-nTerm2-S.zip.
